    ...
    <div class="scroll">  
       ...
       $result = mysqli_query($con,"SELECT * FROM pharmacist");//or die(mysqli_error());
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_pharmacist.php?username=<?php echo $row['username']?>"><img src="images/update-icon.png" width="35" height="35" border="0" hspace="5" /></a></td>
				<td><a href="delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/delete-icon.png" width="35" height="35" border="0" hspace="5"/></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
		...
		<form name="form1" onsubmit="return validateForm(this);" action="admin_pharmacist.php" method="post" >
			...
			<table width="220" height="10" border="0" >	
