...
$cost=$_POST['cost'];
//$sta="Available";
// $pql=mysqli_query($con)
$sql=mysqli_query($con,"INSERT INTO drug(drug_name,category,description,cost,quantity)
VALUES('$sname','$cat','$des','$cost',$qua)");
...
<hr/>	
    <div class="scroll">  
		...
		*/
        ...
        echo "<div style='overflow-y:auto;'><table border='1' cellpadding='5'>";
         echo "<tr><th>Stock ID</th><th>Name</th><th>Category</th><th>Description</th><th>Quantity</th><th>Delete</th></tr>";
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				// echo '<td style="padding:4px">' . $row['date_supplied'] . '</td>';?>
				<!-- <td><a href="update_stock.php?drug_id=<?php echo $row['drug_id']?>"><img src="images/update-icon.png" width="35" height="35" border="0" hspace="5"/></a></td> -->
				<td><a href="delete_stock.php?drug_id=<?php echo $row['drug_id']?>"><img src="images/delete-icon.png" width="24" height="24" border="0" hspace="5"/></a></td></tr>
