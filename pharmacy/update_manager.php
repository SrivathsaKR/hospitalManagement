...
$sql="UPDATE manager SET first_name='$fname', last_name='$lname', staff_id='$sid',postal_address='$postal',phone='$phone',email='$email', password='$pas' WHERE username='$username'";
...
<hr/>	
    <div class="scroll">  
        ...
        <ul class="tabs">  
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Update Managers</a></li>  
              
        </ul>  
          
        <div id="content_1" class="content">  
		<?php echo $message1;?>
       <form name="myform" onsubmit="return validateForm(this);" action="update_manager.php" method="post" >
