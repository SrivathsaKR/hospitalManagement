...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=mysqli_query($con,"SELECT * FROM cashier WHERE username='$user'");//or die(mysqli_error());
...
<hr/>	
    <div class="scroll">  
		...
		*/
        ...
        echo "<tr> <th>Staff_ID</th><th>FirstName </th> <th>LastName </th> <th>Username </th><th>Update </th><th>Delete</th></tr>";
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_cashier.php?username=<?php echo $row['username']?>"><img src="images/update-icon.png" width="35" height="35" border="0" hspace="5" /></a></td>
				<td><a href="delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/delete-icon.png" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
