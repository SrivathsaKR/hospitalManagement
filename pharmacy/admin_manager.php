...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=mysqli_query($con,"SELECT * FROM manager WHERE username='$user'");
// or die(mysqli_error());
...
$message1="<font color=blue>Insertion Failed, Username and StaffID must be Unique</font>";
}
	}}
?>
<!DOCTYPE html>
...
<hr/>	
    <div class="scroll">  
		...
		*/
        ...
        echo "<tr> <th>StaffID</th><th>FirstName </th> <th>LastName </th> <th>Username </th><th>Update </th><th>Delete</th></tr>";
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_manager.php?username=<?php echo $row['username']?>"><img src="images/update-icon.png" width="35" height="35" border="0" hspace="5"/></a></td>
				<td><a href="delete_manager.php?manager_id=<?php echo $row['manager_id']?>"><img src="images/delete-icon.png" width="35" height="35" border="0" hspace="5" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
