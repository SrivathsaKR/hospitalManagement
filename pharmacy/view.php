...
<?php echo $message;
       ...
       $result = mysqli_query($con,"SELECT * FROM pharmacist");//or die(mysql_error());
        ...
        echo "<tr><th>Firstname </th><th>Lastname </th><th>Staff ID </th><th>Phone </th><th>Email </th><th>Username </th><th>Update </th><th>Delete </th></tr>";
        ...
        while($row = mysqli_fetch_array( $result )) {
                ...
                ?>
				<td><a href="update_pharmacist2.php?username=<?php echo $row['username']?>"><img src="images/update-icon.png" width="35" height="35" border="0" hspace="5" /></a></td>
                <td><a href="delete_pharmacist2.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/delete-icon.png" width="35" height="35" border="0" hspace="5" /></a></td>
                <?php
			} 
        // close table>
        echo "</table>";
?> 
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
                ...
                echo '<td>' . $row['username'] . '</td>';
                ?>
				<td><a href="update_cashier2.php?username=<?php echo $row['username']?>"><img src="images/update-icon.png" width="35" height="35" border="0" hspace="5" /></a></td>
                <td><a href="delete_pharmacist2.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/delete-icon.png" width="35" height="35" border="0" hspace="5" /></a></td>
                <?php
