...
<hr/>	
    <div class="scroll">  
		...
		*/
        ...
        $result = mysqli_query($con,"SELECT c.cust_name,s.drug_name,i.qty,s.cost,i.date_in FROM invoice_entry i,drug s,customer c WHERE i.cus_id_fk=c.cust_id AND i.dr_id_fk=s.drug_id"); 
                // or die(mysqli_error());
